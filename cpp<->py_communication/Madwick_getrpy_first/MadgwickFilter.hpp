...
public:
    ...
    */
    void MadgwickAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az, float durationtime);
...
inline void MadgwickFilter::MadgwickAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, float durationtime) {
    ...
    //newTime = (unsigned int)(durationtime * 1000000);//us//////////////////////////////////////////
